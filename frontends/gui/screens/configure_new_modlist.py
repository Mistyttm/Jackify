...
from shared.progress_models import InstallationPhase, InstallationProgress
import os
import subprocess
import sys
import threading
...
from shared.resolution_utils import get_resolution_fallback
...
class ModlistFetchThread(QThread):
    ...
    def run(self):
        ...
        from backend.handlers.subprocess_utils import get_safe_python_executable

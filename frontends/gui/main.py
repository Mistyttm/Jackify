...
from frontends.gui.shared_theme import DEBUG_BORDERS
from frontends.gui.utils import get_screen_geometry, set_responsive_minimum
...
class SettingsDialog(QDialog):
    ...
    def _get_proton_10_path(self):
        ...
        try:
            from backend.handlers.wine_utils import WineUtils
...
class JackifyMainWindow(QMainWindow):
    ...
    def _setup_ui(self, dev_mode=False):
        ...
        from frontends.gui.screens import (
        ...
        from frontends.gui.screens.install_ttw import InstallTTWScreen
        from frontends.gui.screens.wabbajack_installer import WabbajackInstallerScreen
    ...
    def open_about_dialog(self):
        ...
        try:
            from frontends.gui.dialogs.about_dialog import AboutDialog
...
def main():
    ...
    if len(sys.argv) > 1 and '--cli' in sys.argv:
        ...
        try:
            from frontends.cli.__main__ import main as cli_main
    ...
    from shared.logging import LoggingHandler

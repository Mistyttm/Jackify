    ...
    def configuration_phase(self):
        ...
        try:
            ...
            try:
                ...
                from backend.handlers.subprocess_utils import increase_file_descriptor_limit
                ...
                try:
                    from backend.services.resource_manager import handle_file_descriptor_error
        ...
        if (detected_game in supported_games) or is_tuxborn:
            ...
            if not is_gui_mode:
                from backend.handlers.resolution_handler import ResolutionHandler
        ...
        try:
            ...
            try:
                ...
                if existing_app_id:
                    ...
                    from backend.handlers.menu_handler import ModlistMenuHandler
                    from backend.handlers.config_handler import ConfigHandler
                ...
                # NEW modlist configuration - create Steam shortcut first
                    ...
                    from backend.services.native_steam_service import NativeSteamService
                    ...
                    if progress_callback:
                        ...
                        from shared.timing import get_timestamp
